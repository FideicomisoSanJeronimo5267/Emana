...
const ICONS = [
    <svg key={0} width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg key={1} width="34" height="36" viewBox="0 0 34 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg key={2} width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function FeaturesSection({ features }: FeaturesSectionProps = {}) {
    ...
    const texts = features?.length ? features.map(f => f.text ?? '') : DEFAULT_TEXTS
