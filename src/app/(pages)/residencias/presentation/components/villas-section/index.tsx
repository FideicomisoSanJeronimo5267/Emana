...
// Assets
import VillaImage from '@assets/images/residences-page/villa-section.png'
        ...
        <section className={styles.villas__section}>
            <div className={styles.villas__section__info}>
                ...
                <ul className={styles.villas__section__info__features}>
                    ...
                    <li className={styles.villas__section__info__features__item}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_323_1895" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                <rect width="24" height="24" fill="#D9D9D9" />
                            </mask>
                            <g mask="url(#mask0_323_1895)">
                                <path d="M6 18.9999H9.69225V13.1154H14.3077V18.9999H18V9.99993L12 5.46143L6 9.99993V18.9999ZM5 19.9999V9.49993L12 4.21143L19 9.49993V19.9999H13.3077V14.1154H10.6923V19.9999H5Z" fill="#676861" />
                            </g>
                        </svg>
                    ...
                    <li className={styles.villas__section__info__features__item}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_323_1915" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                <rect width="24" height="24" fill="#D9D9D9" />
                            </mask>
                            <g mask="url(#mask0_323_1915)">
                                <path d="M7.5 17.5V6.5H9.5V17.5H7.5ZM14.5 17.5V6.5H16.5V17.5H14.5ZM3 4V3H21V4H3ZM3 21V20H21V21H3Z" fill="#676861" />
                            </g>
                        </svg>
            ...
            <div className={styles.villas__section__image}>
                <Image
                    ...
                    src={residencesImagesdata.rooftop.src}
                    alt={residencesImagesdata.rooftop.alt}
                    blurDataURL={residencesImagesdata.rooftop.blurData}
                    placeholder={"blur"}
                    fill
                />
            </div>
