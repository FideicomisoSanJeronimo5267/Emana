...
import ApartmentImage from '@assets/images/residences-page/apartment.png'
    ...
    return (
        <section className={styles.apartment__section}>
            <div className={styles.apartment__section__image}>
                <Image className={styles.apartment__section__cover__image} src={ApartmentImage} alt={'Apartment'}/>
            </div>
            <div className={styles.apartment__section__apartment__info}>
                <h2 className={styles.apartment__section__apartment__info__title}>Departamentos</h2>
                <p className={styles.apartment__section__apartment__info__description}>
                    Combinan distribución inteligente, acabados premium y vistas inigualables. Cada espacio fue diseñado para aprovechar la luz natural y mantener una sensación constante de amplitud y calma.
                </p>
                ...
                <ul className={styles.apartment__section__apartment__info__features}>
                    ...
                    <li className={styles.apartment__section__apartment__info__features__item}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_323_1852" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                <rect width="24" height="24" fill="#D9D9D9" />
                            </mask>
                            <g mask="url(#mask0_323_1852)">
                                <path d="M3 18V13C3 12.7038 3.08525 12.3884 3.25575 12.0538C3.42625 11.7193 3.67433 11.468 4 11.3V9C4 8.43583 4.19233 7.9615 4.577 7.577C4.9615 7.19233 5.43583 7 6 7H10.5C10.8448 7 11.1391 7.07083 11.3828 7.2125C11.6263 7.35417 11.832 7.55 12 7.8C12.168 7.55 12.3738 7.35417 12.6173 7.2125C12.8609 7.07083 13.1552 7 13.5 7H18C18.5642 7 19.0385 7.19233 19.423 7.577C19.8077 7.9615 20 8.43583 20 9V11.3C20.3257 11.468 20.5738 11.7193 20.7443 12.0538C20.9148 12.3884 21 12.7038 21 13V18H20V16H4V18H3ZM12.5 11H19V9C19 8.71667 18.9042 8.47917 18.7125 8.2875C18.5208 8.09583 18.2833 8 18 8H13.5C13.2167 8 12.9792 8.09583 12.7875 8.2875C12.5958 8.47917 12.5 8.71667 12.5 9V11ZM5 11H11.5V9C11.5 8.71667 11.4042 8.47917 11.2125 8.2875C11.0208 8.09583 10.7833 8 10.5 8H6C5.71667 8 5.47917 8.09583 5.2875 8.2875C5.09583 8.47917 5 8.71667 5 9V11ZM4 15H20V13C20 12.7167 19.9042 12.4792 19.7125 12.2875C19.5208 12.0958 19.2833 12 19 12H5C4.71667 12 4.47917 12.0958 4.2875 12.2875C4.09583 12.4792 4 12.7167 4 13V15Z" fill="#95978C" />
                            </g>
                        </svg>
